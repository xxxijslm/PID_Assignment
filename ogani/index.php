        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/imgProduct/p006.jpg">
                        <div class="hero__text">
                            <span>日月餅</span>
                            <h2>手工餅乾 <br />100%紅茶粉及進口奶油</h2>
                            <p>歡迎現場試吃購買</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>地址：台中市西屯區西屯路2段100號</li>
                            <li>電話： +65 11.188.888</li>
                            <li>Email： shopping@cart.com</li>
                        </ul>
                    </div>
                </div>
